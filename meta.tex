...
\makenomenclature
\renewcommand{\nomname}{Lista de Abrevituras e Siglas}
...
\fancyhead{}
% Número da página do lado direito [R] nas páginas ímpares [O] e do lado esquerdo [L] nas páginas pares [E]
\fancyhead[RO,LE]{\thepage}
% Nome da seção do lado esquerdo em páginas ímpares
\fancyhead[LO]{\nouppercase{\rightmark}}
% Nome do capítulo do lado direito em páginas pares
\fancyhead[RE]{\nouppercase{\leftmark}}
...
% Dados do tcc
\newcommand{\autor}{Clésio de Araújo Gonçalves}
\newcommand{\nome}{Gonçalves, Clésio de Araújo}
\newcommand{\titulo}{Desenvolvimento Guiado por Comportamento usando Processamento de Linguagem Natural}
\newcommand{\instituicao}{Instituto Federal de Educação, Ciência e Tecnologia do Piauí (IFPI)}
\newcommand{\instituto}{Instituto Federal do Piauí (IFPI)}
\newcommand{\eixo}{Eixo de Informação e Comunicação}
\newcommand{\curso}{Tecnologia em Análise e Desenvolvimento de Sistemas}
\newcommand{\local}{Picos (PI)}
\newcommand{\ano}{2016}
\newcommand{\orientador}{Rogerio Figueredo de Sousa}
\newcommand{\coorientador}{Manoel Messias Pereira Medeiros}
\newcommand{\convidado}{João Paulo Lima do Nascimento }
\newcommand{\tipotrabalho}{Trabalho de Conclusão de Curso}
\newcommand{\preambulo}{
  \tipotrabalho \, apresentado ao programa de graduação em \curso  no IFPI
  – Campus Picos, como requisito parcial para obtenção do título de tecnólogo em Análise e 
...
% Tamanho fonte da seção e subseção
\usepackage{sectsty}
\sectionfont{\fontsize{12pt}{15}\selectfont}
\subsectionfont{\fontsize{12pt}{15}\selectfont}

%Páginas em PDF
\usepackage{pdfpages}

%espaço entre a margem e o início da frase do parágrafo
...
% citação alfanumérica no padrão ABNT
\usepackage[alf]{abntex2cite}

%Espaçamento entre parágrafos de 6pt
\setlength{\parskip}{6pt}

%carrega o pacote mhchem para equações químicas
